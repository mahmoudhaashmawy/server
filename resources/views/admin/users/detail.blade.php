            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $booked_tour }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Booked Tour')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--10 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.seminars.booking.log', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-calendar-day"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $booked_seminar }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Booked Seminar')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
