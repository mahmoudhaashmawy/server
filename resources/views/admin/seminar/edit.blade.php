                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category" name="category_id" required="">
                                        ...
                                        @forelse($categories as $item)
                                            <option value="{{ $item->id }}" {{ $seminar->category_id == $item->id ? 'selected' : null }}>{{ __(@$item->name) }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="location" class="form-control" value="{{ $seminar->location }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="map_latitude" class="form-control" value="{{ $seminar->map_latitude }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="map_longitude" class="form-control" value="{{ $seminar->map_longitude }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="duration" class="form-control" value="{{ $seminar->duration }}"
                                           autocomplete="off" name="duration" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="departure_time">@lang('Start Time')</label>
                                    <input type="text" class="form-control timepicker" id="departure_time" value="{{ \Carbon\Carbon::parse($seminar->start_time)->format('Y-m-d h:i a') }}"
                                           autocomplete="off" name="start_time" required="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="return_time">@lang('End Time')</label>
                                    <input type="text" class="form-control timepicker" id="return_time" value="{{ \Carbon\Carbon::parse($seminar->end_time)->format('Y-m-d h:i a') }}"
                                           autocomplete="off" name="end_time" required="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="capacity">@lang('Capacity')</label>
                                    <input type="text" class="form-control" id="capacity" value="{{ $seminar->capacity }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="price" name="price"
                                               value="{{ getAmount($seminar->price) }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2-auto-tokenize" name="included[]" multiple="multiple">
                                        @forelse($seminar->included as $item)
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2-auto-tokenize" name="excluded[]" multiple="multiple">
                                        @forelse($seminar->excluded as $item)
                                            <option value="{{ $item }}" selected>{{ $item }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" name="details" class="form-control nicEdit"
                                              id="nicEditor0">{{ $seminar->details }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="card border--dark mb-4">
                                    ...
                                    <div class="card-body">
                                        <p><small class="text-facebook">@lang('Images will be resize into')
                                            {{ imagePath()['seminars']['size'] }}px</small></p>
                                                            ...
                                                            <div class="thumb" style="position: relative;">
                                                                <div class="avatar-preview">
                                                                    <div class="profilePicPreview"
                                                                         style="background-image: url('{{ getImage(imagePath()["seminars"]["path"] . "/" . $image) }}')">

                                                                    </div>
                                                                </div>

                                                                <div class="avatar-remove">
                                                                    <button class="bg-danger deleteOldImage" onclick="return false" data-removeindex="imageItem{{ $loop->iteration }}" data-deletelink="{{ route('admin.seminars.image.delete', [$seminar->id, $image]) }}"><i class="la la-close"></i></button>
                                                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card border--dark">
                                    <h5 class="card-header bg--dark">@lang('Seminar Plan')
                                        <button type="button"
                                    ...
                                    <div class="card-body">
                                        <div class="row addedField">
                                            ...
                                            @forelse($seminar->seminar_plan as $key => $info)
                                                <div class="col-md-12 other-info-data">
                                                    <div class="form-group">
                                                        <div class="input-group mb-md-0 mb-4">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input name="subtitle[]" value="{{ $info[1] }}" class="form-control" type="text" required placeholder="@lang('Title')">
                                                            </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.seminars.index') }}" class="btn btn-sm btn--primary box--shadow1 text-white text--small"><i
