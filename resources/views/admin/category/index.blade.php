                            ...
                            @forelse ($categories as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn ml-1 editBtn" data-original-title="@lang('Edit')" data-toggle="tooltip" data-url="{{ route('admin.category.update', $item->id)}}" data-name="{{ $item->name }}">
