            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.plans*',3)}}">
                        ...
                        <span class="menu-title">@lang('Tour Plan') </span>
                    </a>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.plans.booking.log'])}}">
                                <a href="{{route('admin.plans.booking.log')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Booking Log')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.seminars*',3)}}">
                        <i class="menu-icon la la-calendar"></i>
                        <span class="menu-title">@lang('Seminar') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.seminars*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.seminars.index','admin.seminars.add', 'admin.seminars.edit'])}}">
                                <a href="{{route('admin.seminars.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Seminars')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.seminars.booking.log'])}}">
                                <a href="{{route('admin.seminars.booking.log')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Booking Log')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.ratings')}}">
