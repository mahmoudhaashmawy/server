...
@section('content')
    <div class="container pt-50 pb-50">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="trip-card card-deposit ">
                        ...
                        <form action="{{ route('user.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <div class="my-3 text-center">@php echo  $data->gateway->description @endphp</div>
                                        ...
                                        @if($v->type == "text")
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form--control" name="{{$k}}" value="{{old($k)}}" placeholder="{{__($v->field_level)}}" {{ $v->validation == 'required' ? 'required' : null }}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="position-relative">
                                                        ...
                                                        <label for="inputAttachments">{{__($v->field_level)}}{{ $v->validation == '*' ? 'required' : null }}</label>
                                                    </div>                                                
                                                </div>
                                            </div>
                                        @endif
