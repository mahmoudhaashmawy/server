      ...
      <div class="account-form-area">
        ...
        <form class="account-form mt-5" method="POST" action="{{ route('user.password.update') }}">
            ...
            <div class="form-group hover-input-popup">
                ...
                <input id="password" type="password" class="form--control @error('password') is-invalid @enderror" name="password" required placeholder="@lang('Enter New Password')">
            ...
            <div class="form-group">
                <label for="password-confirm">@lang('Confirm Password')</label>
                    <input id="password-confirm" type="password" class="form--control" placeholder="@lang('Re-type Password')" name="password_confirmation" required>
            </div>

          <div class="form-group mt-4">
            <button type="submit" class="btn btn--base w-100" id="recaptcha">@lang('Reset Password')</button>
          </div>
        </form>
      </div>
    </div>
