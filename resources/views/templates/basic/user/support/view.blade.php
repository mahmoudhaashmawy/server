...
@endguest
    ...
    <div class="container pb-50 pt-50">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="trip-card">
                    <div class="card-header bg-white card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-md-8">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <a href="javascript:void(0)" class="btn btn--base btn-sm addFile">
