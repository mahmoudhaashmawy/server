          ...
          <div class="row gy-4">
            <div class="col-lg-3 col-sm-6">
              <div class="d-widget">
                <div class="d-widget__icon">
                  ...
                  <a href="{{ route('user.tour.log') }}" class="view-all">@lang('View All')</a>
                </div>
                <div class="d-widget__content">
                  <h3 class="d-widget__number ">{{ $total_tours }}</h3>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="d-widget">
                ...
                <div class="d-widget__content">
                  <h3 class="d-widget__number ">{{ $upcoming_tours }}</h3>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="d-widget">
                <div class="d-widget__icon">
                  ...
                  <a href="{{ route('user.seminar.log') }}" class="view-all">@lang('View All')</a>
                </div>
                <div class="d-widget__content">
                  <h3 class="d-widget__number ">{{ $total_seminars }}</h3>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="d-widget">
                ...
                <div class="d-widget__content">
                  <h3 class="d-widget__number">{{ $upcoming_seminars }}</h3>
                ...
                <div class="table-responsive--md">
                    <table class="table custom--table">
                        ...
                        <tbody>
                            ...
                            @forelse($payment_history as $k=>$data)
                                <tr>
