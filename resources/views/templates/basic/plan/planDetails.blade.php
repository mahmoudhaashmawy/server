...
<section class="pb-100">
    <div class="single-package-header bg_img" style="background-image: url('{{ getImage('assets/images/frontend/plan_breadcrumb/' . @$plan_breadcrumb->data_values->background_image, '1920x1131') }}');">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
        ...
        <div class="col-lg-8 pe-lg-5">
          ...
          <div class="tab-content mt-5 package-tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
              <img src="{{ getImage(imagePath()['plans']['path'].'/'.@$plan->images[0], imagePath()['plans']['size']) }}" class="w-100 mb-4 tour-plan-img" alt="image">
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <div class="gallery-card">
                      <img src="{{ getImage(imagePath()['plans']['path'].'/'.$image, imagePath()['plans']['size']) }}" alt="image">
            ...
            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="plan-tab">
                @forelse ($plan->tour_plan as $item)
              ...
              <div class="course-details-review mb-5">
                <div class="rating-area d-flex flex-wrap align-items-center justify-content-between mb-4">
                  ...
                  <div class="content">
                    ...
                    <span class="mt-1 text-muted fs--14px">@lang('Based on') {{ @$plan->ratings_count }} @lang('ratings')</span>
                  </div>
                </div>
                <div class="single-review">
                  <p class="star"><i class="las la-star text--base"></i> 5</p>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{ @(($plan->ratings()->where('rating', 5)->count())/$plan->ratings_count*100) }}%" aria-valuenow="{{ @(($plan->ratings()->where('rating', 5)->count())/$plan->ratings_count*100) }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="percentage">{{ @getAmount(($plan->ratings()->where('rating', 5)->count())/$plan->ratings_count*100) }}%</span>
                </div><!-- single-review end -->
                <div class="single-review">
                  <p class="star"><i class="las la-star text--base"></i> 4</p>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{ @(($plan->ratings()->where('rating', 4)->count())/$plan->ratings_count*100) }}%" aria-valuenow="{{ @(($plan->ratings()->where('rating', 4)->count())/$plan->ratings_count*100) }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="percentage">{{ @getAmount(($plan->ratings()->where('rating', 4)->count())/$plan->ratings_count*100) }}%</span>
                </div><!-- single-review end -->
                <div class="single-review">
                  <p class="star"><i class="las la-star text--base"></i> 3</p>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{ @(($plan->ratings()->where('rating', 3)->count())/$plan->ratings_count*100) }}%" aria-valuenow="{{ @(($plan->ratings()->where('rating', 3)->count())/$plan->ratings_count*100) }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="percentage">{{ @getAmount(($plan->ratings()->where('rating', 3)->count())/$plan->ratings_count*100) }}%</span>
                </div><!-- single-review end -->
                <div class="single-review">
                  <p class="star"><i class="las la-star text--base"></i> 2</p>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{ @(($plan->ratings()->where('rating', 2)->count())/$plan->ratings_count*100) }}%" aria-valuenow="{{ @(($plan->ratings()->where('rating', 2)->count())/$plan->ratings_count*100) }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="percentage">{{ @getAmount(($plan->ratings()->where('rating', 2)->count())/$plan->ratings_count*100) }}%</span>
                </div><!-- single-review end -->
                <div class="single-review">
                  <p class="star"><i class="las la-star text--base"></i> 1</p>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{ @(($plan->ratings()->where('rating', 1)->count())/$plan->ratings_count*100) }}%" aria-valuenow="{{ @(($plan->ratings()->where('rating', 1)->count())/$plan->ratings_count*100) }}" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="percentage">{{ @getAmount(($plan->ratings()->where('rating', 1)->count())/$plan->ratings_count*100) }}%</span>
                </div><!-- single-review end -->
              </div>
        ...
        <div class="col-lg-4">
          <div class="package-sidebar-widget">
            <div class="thumb">
              ...
              <div class="price"><span class="fs--14px">{{ $general->cur_sym }}</span> {{ showAmount($plan->price) }}</div>
            </div>
            <div class="content mt-5">
              ...
              <ul class="caption-list mt-5">
                ...
                <li>
                  ...
                  <span class="value text-end text--base">{{ $plan->capacity }} @lang('Persons')</span>
                </li>
              </ul>
              ...
              <div class="blog-details-footer mt-4">
                ...
                <ul class="share-post-links">
                  <li><a href="http://twitter.com/share?url={{ route('plan.details', [$plan->id, slug($plan->name)]) }}" target="_blank" class="twitter"><i class="lab la-twitter m-0"></i> </a></li>
                  <li><a href="http://www.facebook.com/sharer.php?u={{ route('plan.details', [$plan->id, slug($plan->name)]) }}" target="_blank" class="facebook"><i class="lab la-facebook-f m-0"></i></a></li>
                </ul>
              </div>
          </div>
        </div>
  ...
  <!-- Modal -->
@if (auth()->check())
  @if ($plan->departure_time > now() && $plan->sold != $plan->capacity)
          ...
          <div class="modal-body">          
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="number" min="1" max="{{ $plan->capacity - $plan->sold }}" class="form--control" name="seat" id="seat" placeholder="@lang('Enter Number of Seat')">
