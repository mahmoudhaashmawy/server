...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Plan and Seminar
        $widget['total_plans'] = Plan::where('status',1)->count();
        $widget['total_booked_tours'] = PlanLog::where('status',1)->where('type','tour')->count();
        $widget['total_seminars'] = Seminar::where('status',1)->count();
        $widget['total_booked_seminars'] = PlanLog::where('status',1)->where('type','seminar')->count();
        ...
        $payment['total_deposit_pending_amount'] = Deposit::where('status',2)->sum('amount');
        $payment['total_deposit_rejected_amount'] = Deposit::where('status',3)->sum('amount');
